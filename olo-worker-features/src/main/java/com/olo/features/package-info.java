 ...
 *   <li>Phase contracts (implement one or more per feature): {@link com.olo.features.PreNodeCall} (PRE), {@link com.olo.features.PostSuccessCall} (POST_SUCCESS), {@link com.olo.features.PostErrorCall} (POST_ERROR), {@link com.olo.features.FinallyCall} (FINALLY), {@link com.olo.features.PreFinallyCall} (PRE_FINALLY). Legacy {@link com.olo.features.PostNodeCall} is a fallback for any post phase.</li>
